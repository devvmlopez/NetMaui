...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.CurrentActivity.ActivityLifecycleContextListener, Plugin.Maui.CurrentActivity", ActivityLifecycleContextListener.class, __md_methods);
	}
	...
	public ActivityLifecycleContextListener ()
	{
		...
		if (getClass () == ActivityLifecycleContextListener.class) {
			mono.android.TypeManager.Activate ("Plugin.CurrentActivity.ActivityLifecycleContextListener, Plugin.Maui.CurrentActivity", "", this, new java.lang.Object[] {  });
		}
	}
